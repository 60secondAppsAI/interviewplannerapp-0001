					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateInterviewSlot()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2InterviewSlots = true">Add</base-button>
								              <modal :show.sync="modal2InterviewSlots">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Interview Slot Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="InterviewSlotId" type="text" placeholder="Enter InterviewSlotId" v-model="interviewSlotDetails.interviewSlotId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Start Time</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="interviewSlotDetails.startTime"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">End Time</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="interviewSlotDetails.endTime"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  data() {
    return {
      interviewSlotToAdd: {},
      modal2InterviewSlots: false,
      interviewSlotDetails: null,
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2InterviewSlots = false;
    ...
    async updateInterviewSlot() {
      ...
      const jsonData = JSON.stringify(this.interviewSlotDetails);
      const res = await InterviewSlotService.update(jsonData);
...
//        this.getAllInterviewSlots();
    ...
    async getInterviewSlotDetails() {
      try {
			let response = await InterviewSlotService.get(this.interviewSlotId);
			this.interviewSlotDetails = response.data;
