					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateJobDescription()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2JobDescriptions = true">Add</base-button>
								              <modal :show.sync="modal2JobDescriptions">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Job Description Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="JobDescriptionId" type="text" placeholder="Enter JobDescriptionId" v-model="jobDescriptionDetails.jobDescriptionId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Role Title</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="RoleTitle" type="text" placeholder="Enter RoleTitle" v-model="jobDescriptionDetails.roleTitle"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Department</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Department" type="text" placeholder="Enter Department" v-model="jobDescriptionDetails.department"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">File Path</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FilePath" type="text" placeholder="Enter FilePath" v-model="jobDescriptionDetails.filePath"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  data() {
    return {
      jobDescriptionToAdd: {},
      modal2JobDescriptions: false,
      jobDescriptionDetails: null,
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2JobDescriptions = false;
    ...
    async updateJobDescription() {
      ...
      const jsonData = JSON.stringify(this.jobDescriptionDetails);
      const res = await JobDescriptionService.update(jsonData);
...
//        this.getAllJobDescriptions();
    ...
    async getJobDescriptionDetails() {
      try {
			let response = await JobDescriptionService.get(this.jobDescriptionId);
			this.jobDescriptionDetails = response.data;
