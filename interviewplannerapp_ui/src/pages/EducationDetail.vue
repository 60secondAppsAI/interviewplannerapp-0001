					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateEducation()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Educations = true">Add</base-button>
								              <modal :show.sync="modal2Educations">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Education Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="EducationId" type="text" placeholder="Enter EducationId" v-model="educationDetails.educationId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Institution</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Institution" type="text" placeholder="Enter Institution" v-model="educationDetails.institution"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Degree</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Degree" type="text" placeholder="Enter Degree" v-model="educationDetails.degree"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Year Of Graduation</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="YearOfGraduation" type="text" placeholder="Enter YearOfGraduation" v-model="educationDetails.yearOfGraduation"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateEducation() {
      ...
      const jsonData = JSON.stringify(this.educationDetails);
      const res = await EducationService.update(jsonData);
...
//        this.getAllEducations();
    ...
    async getEducationDetails() {
      try {
			let response = await EducationService.get(this.educationId);
