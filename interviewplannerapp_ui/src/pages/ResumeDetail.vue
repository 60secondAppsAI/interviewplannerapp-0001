					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateResume()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Resumes = true">Add</base-button>
								              <modal :show.sync="modal2Resumes">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Resume Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ResumeId" type="text" placeholder="Enter ResumeId" v-model="resumeDetails.resumeId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Candidate Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CandidateName" type="text" placeholder="Enter CandidateName" v-model="resumeDetails.candidateName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Candidate Email</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CandidateEmail" type="text" placeholder="Enter CandidateEmail" v-model="resumeDetails.candidateEmail"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">File Path</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FilePath" type="text" placeholder="Enter FilePath" v-model="resumeDetails.filePath"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateResume() {
      ...
      const jsonData = JSON.stringify(this.resumeDetails);
      const res = await ResumeService.update(jsonData);
...
//        this.getAllResumes();
    ...
    async getResumeDetails() {
      try {
			let response = await ResumeService.get(this.resumeId);
			this.resumeDetails = response.data;
