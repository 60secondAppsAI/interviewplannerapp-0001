            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Title</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Title" type="text" placeholder="Enter Title" v-model="roleDetails.title"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Level</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Level" type="text" placeholder="Enter Level" v-model="roleDetails.level"></input>
																		</div>
						</td>
														</tr>
