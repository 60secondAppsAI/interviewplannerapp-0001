              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Experience Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Company Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CompanyName" type="text" placeholder="Enter CompanyName" v-model="experienceDetails.companyName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Role Title</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="RoleTitle" type="text" placeholder="Enter RoleTitle" v-model="experienceDetails.roleTitle"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Years</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Years" type="text" placeholder="Enter Years" v-model="experienceDetails.years"></input>
																		</div>
						</td>
														</tr>
