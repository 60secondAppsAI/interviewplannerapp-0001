...
<template>
        ...
        <card>
          <template slot="header">
            <div class="row justify-content-between align-items-between mx-3">
              ...
              <div>
                  <base-button class="btn btn-primary" @click="modalDepartments = true">Add</base-button>
              </div>
              
              <modal :show.sync="modalDepartments">
                <template slot="header">
  ...
  <base-input label="DepartmentId" type="text" placeholder="Enter DepartmentId" v-model="departmentToAdd.departmentId"></base-input>
          ...
          <div v-if="isTableView">
            ...
            <a-table :columns="columns" :data-source="departments" :row-key="record => record.DepartmentId" :pagination="pagination"
          ...
          <div v-else>
            ...
            <DepartmentPictureView :departments="departments" />
          </div>
...
import DepartmentPictureView from './DepartmentPictureView.vue';
...
export default {
  ...
  data() {
    return {
      ...
      sortBy: 'departmentId',           // Column to sort by
  ...
  methods: {
    ...
    async renderDepartmentsTable() {
      ...
      for (let i = 0; i < this.departments.length; i++) {
        departmentsTableData.push({
          ...
          year: this.departments[i].year,
          date: this.departments[i].date,
          competitionId: this.departments[i].competitionId,
          departmentId: this.departments[i].departmentId,
        });
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-departments',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    handleSearchQueryChanged() {
    	...
    	this.$root.$emit('searchQueryForDepartmentsChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.departmentToAdd.created = currentDate;
